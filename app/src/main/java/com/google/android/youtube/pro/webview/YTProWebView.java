...
public class YTProWebView extends WebView {
	...
	protected void onWindowVisibilityChanged(int visibility) {
		...
		boolean allowWhilePip = (getContext() instanceof MainActivity) && ((MainActivity) getContext()).isPip;
		if (visibility != View.GONE && visibility != View.INVISIBLE || !bgPlay || allowWhilePip){
